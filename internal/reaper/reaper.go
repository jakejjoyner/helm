...
func parentExcludeJoin(dbName string) (joinClause, whereCondition string) {
	joinClause = `LEFT JOIN (
		...
		LEFT JOIN wisps pw ON pw.id = COALESCE(wd.depends_on_issue_id, wd.depends_on_wisp_id, wd.depends_on_external) LEFT JOIN issues pi ON pi.id = COALESCE(wd.depends_on_issue_id, wd.depends_on_wisp_id, wd.depends_on_external)
